...
const CELTIC_LAYOUT = [
  ...
  { x: -1.3, y: 0, rotate: 0 },        // 3: Past (left)
  { x: 1.3, y: 0, rotate: 0 },         // 4: Future (right)
  { x: 0, y: -1.5, rotate: 0 },        // 5: Above (crown)
  { x: 0, y: 1.5, rotate: 0 },         // 6: Below (foundation)
  { x: 2.5, y: 2.25, rotate: 0 },      // 7: Advice (staff bottom)
  { x: 2.5, y: 0.75, rotate: 0 },      // 8: External (staff)
  { x: 2.5, y: -0.75, rotate: 0 },     // 9: Hopes/Fears (staff)
  { x: 2.5, y: -2.25, rotate: 0 },     // 10: Outcome (staff top)
]
